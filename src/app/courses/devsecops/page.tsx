...
export const metadata: Metadata = {
  title: "DevOps & DevSecOps Course | UZYNTRA Security",
  description: "CI/CD pipelines, infrastructure as code, container security, and security integrated into every stage of software delivery.",
  alternates: { canonical: `${siteConfig.url}/courses/devsecops` },
};

const modules = [
  { step: "01", title: "DevOps Foundations", body: "Git workflows, CI/CD concepts, and the DevOps culture and toolchain." },
  { step: "02", title: "CI/CD Pipelines", body: "GitHub Actions, GitLab CI, Jenkins — build, test, and deploy automation." },
  { step: "03", title: "Infrastructure as Code", body: "Terraform, Ansible, and CloudFormation for reproducible infrastructure." },
  { step: "04", title: "DevSecOps & Security Gates", body: "SAST, DAST, SCA, secrets scanning, and container security in pipelines." },
];

const outcomes = [
  "Build and maintain CI/CD pipelines",
  "Write infrastructure as code with Terraform",
  "Integrate security scanning into delivery pipelines",
  "Manage containers securely with Docker and Kubernetes",
  "Implement secrets management and policy enforcement",
  "Apply DevSecOps practices to real-world projects",
];
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              <Link href="/courses/cloud-computing" className="surface-card group flex items-center justify-between p-5 transition-all duration-200 hover:-translate-y-0.5 hover:border-red-200">
                <div>
                  ...
                  <p className="mt-1 text-xs text-slate-500">AWS, Azure, and GCP for cloud deployments.</p>
                </div>
              ...
              <Link href="/courses/docker-kubernetes" className="surface-card group flex items-center justify-between p-5 transition-all duration-200 hover:-translate-y-0.5 hover:border-red-200">
                <div>
                  ...
                  <p className="mt-1 text-xs text-slate-500">Container orchestration for production.</p>
                </div>
                <ArrowRight className="h-4 w-4 shrink-0 text-slate-300 transition-all group-hover:translate-x-1 group-hover:text-red-500" aria-hidden="true" />
              </Link>
            </div>
      ...
      <section className="cta-section relative overflow-hidden bg-gradient-to-br from-red-800 via-red-700 to-red-600 py-14 text-white sm:py-16">
        ...
        <div className="relative z-10 container-shell">
          <div className="mx-auto flex max-w-2xl flex-col items-center text-center">
            <h2 className="text-2xl font-bold text-white sm:text-3xl">Ship faster, ship securely</h2>
            <p className="mt-4 text-base leading-7 text-white/90">Enroll in DevSecOps and build pipelines that deliver security at speed.</p>
