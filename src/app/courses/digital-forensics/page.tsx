...
export const metadata: Metadata = {
  title: "Digital Forensics Course | UZYNTRA Security",
  description: "Digital forensics investigation, disk and memory analysis, malware analysis, and chain of custody for security professionals.",
  alternates: { canonical: `${siteConfig.url}/courses/digital-forensics` },
};

const modules = [
  { step: "01", title: "Forensics Fundamentals", body: "Evidence handling, chain of custody, legal considerations, and forensic methodology." },
  { step: "02", title: "Disk & File System Forensics", body: "Disk imaging, file recovery, artifact analysis, and timeline reconstruction." },
  { step: "03", title: "Memory & Network Forensics", body: "Volatility for memory analysis, PCAP analysis, and network artifact investigation." },
  { step: "04", title: "Malware Analysis", body: "Static and dynamic malware analysis, sandbox environments, and IOC extraction." },
];

const outcomes = [
  "Conduct digital forensic investigations end-to-end",
  "Acquire and analyze disk images forensically",
  "Perform memory forensics with Volatility",
  "Analyze network traffic for forensic artifacts",
  "Perform basic static and dynamic malware analysis",
  "Maintain chain of custody and write forensic reports",
];
...
export default function DigitalForensicsCourse() {
  return (
    <main id="main-content">
      <CourseHeroImage src="/images/courses/digital-forensics.webp" alt="Digital Forensics Course" />
      <PageHero
        eyebrow="Course — Digital Forensics"
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              ...
              <Link href="/courses/ethical-hacking" className="surface-card group flex items-center justify-between p-5 transition-all duration-200 hover:-translate-y-0.5 hover:border-red-200">
                <div>
                  ...
                  <p className="mt-1 text-xs text-slate-500">Understand attacker techniques for better forensics.</p>
                </div>
                <ArrowRight className="h-4 w-4 shrink-0 text-slate-300 transition-all group-hover:translate-x-1 group-hover:text-red-500" aria-hidden="true" />
              </Link>
            </div>
      ...
      <section className="cta-section relative overflow-hidden bg-gradient-to-br from-red-800 via-red-700 to-red-600 py-14 text-white sm:py-16">
        ...
        <div className="relative z-10 container-shell">
          <div className="mx-auto flex max-w-2xl flex-col items-center text-center">
            <h2 className="text-2xl font-bold text-white sm:text-3xl">Find the truth in the data</h2>
            <p className="mt-4 text-base leading-7 text-white/90">Enroll and develop the forensic skills to investigate any incident.</p>
