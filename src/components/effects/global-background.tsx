  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute left-0 top-[-25%] h-[28%] w-full animate-[uzyntraScan_12s_linear_infinite] bg-[linear-gradient(to_bottom,transparent,rgba(239,68,68,0.05),transparent)] blur-2xl" />
      </div>

      {/* Floating orb 1 */}
      <div className="absolute left-[8%] top-[20%] h-28 w-28 animate-[uzyntraFloatA_14s_ease-in-out_infinite] rounded-full bg-red-400/[0.07] blur-3xl" />

      {/* Floating orb 2 */}
      <div className="absolute right-[8%] top-[45%] h-36 w-36 animate-[uzyntraFloatB_18s_ease-in-out_infinite] rounded-full bg-rose-400/[0.07] blur-3xl" />
