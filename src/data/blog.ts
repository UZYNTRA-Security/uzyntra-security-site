...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    title: "API Security Testing Guide for SaaS Startups: Complete 2026 Guide (With Real Attack Examples)",
    excerpt:
  ...
  {
    slug: "bola-vulnerability-explained",
    title: "BOLA Vulnerability Explained (IDOR in APIs) — Real Attack Examples",
    excerpt: "BOLA is the #1 exploited API vulnerability. Learn what it is, how attackers use it to access other users' data, and exactly how to fix it with server-side ownership checks.",
    category: "API Security",
    tag: "BOLA",
    date: "January 2026",
    readTime: "7 min read",
    externalUrl: "https://dev.to/uzyntra",
    platform: "UZYNTRA",
    targetKeyword: "BOLA vulnerability",
    serviceLink: "/services/api-security-testing",
    cta: "Test for BOLA",
    published: true,
  },
  {
    slug: "owasp-api-top-10-2026",
    title: "OWASP API Top 10 Explained (2026 Complete Guide With Real Examples)",
    excerpt: "Complete breakdown of all 10 OWASP API Security Top 10 vulnerabilities — with real attack scenarios, examples, and fixes for modern SaaS and API platforms.",
    category: "API Security",
    tag: "OWASP API Top 10",
    date: "February 2026",
    ...
    externalUrl: "https://dev.to/uzyntra",
    platform: "UZYNTRA",
    targetKeyword: "OWASP API Top 10 2026",
    serviceLink: "/services/api-security-testing",
    cta: "Request API Security Audit",
    published: true,
  },
  {
    slug: "api-authentication-security-guide",
    title: "API Authentication Security Guide (JWT Attacks, OAuth Risks, Token Best Practices)",
    excerpt: "JWT algorithm confusion, OAuth redirect URI abuse, token storage mistakes — the real authentication vulnerabilities attackers exploit and how to prevent them.",
    category: "API Security",
    tag: "JWT Security",
    date: "February 2026",
    readTime: "9 min read",
    externalUrl: "https://dev.to/uzyntra",
    platform: "UZYNTRA",
    targetKeyword: "API authentication security",
    serviceLink: "/services/api-security-testing",
    cta: "Test Your Auth System",
    published: true,
  },
  {
